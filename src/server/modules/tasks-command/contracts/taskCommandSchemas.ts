...
export const taskTransitionSchema = z.enum(["start", "complete", "reopen"]);
...
}).strict().refine(data => data.title !== undefined || data.description !== undefined || data.priority !== undefined || data.dueAt !== undefined, {
